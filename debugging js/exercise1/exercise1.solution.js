...
// 2. Set a break point at line 6, and refresh the page in your browser to trigger the breakpoint.
...
function printIds(inpArray) {
  ...
  //    is paused at line 25.
  for (let i = 0; i < inpArray.length; i++)
  {
    // 5. When the debugger is paused on line 25, Examine the contents of "inpArray" by hovering
    ...
    //    the console.log() function call at line 25. Rewrite line 25 so that the program 

/** 
 * This example demonstates an order of operations bug
 * between the loading of JS, and the loading of HTML elements
 * Check the exercise.html and console output in dev tools for hints. 
 *
 */
